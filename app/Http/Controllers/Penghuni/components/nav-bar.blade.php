        ...
        <nav class="bg-gray-800" x-data="{ isOpen: false }">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <x-nav-link href="/kamar" :active="request()->is('kamar')">Kamar Anda</x-nav-link>
                                <x-nav-link href="/pembayaran" :active="request()->is('pembayaran')">Pembayaran</x-nav-link>
                                <x-nav-link href="/pelaporan" :active="request()->is('pelaporan')">Pelaporan</x-nav-link>
                            ...
                            <div class="relative ml-3">
                                <div>
                                    <button type="button" @click="isOpen = !isOpen"
                                        ...
                                        <div class="ml-3">
                                            <div class="text-gray-300 px-3 py-2 text-sm font-medium">Nama Pengguna</div>
                                        </div>
            ...
            <div x-show="isOpen" class="md:hidden" id="mobile-menu">
                <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                    ...
                    <a href="/kamar" class="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white"
                ...
                <div class="border-t border-gray-700 pb-3 pt-4">
                    <div class="flex items-center px-5">
                        ...
                        <div class="ml-3">
                            <div class="text-base font-medium leading-none text-gray-300">Nama Pengguna</div>
                            <div class="text-sm font-medium leading-none text-gray-500 py-1">08xx-xxxx-xxxx</div>
                        </div>
                        {{-- NOTIFIKASI  --}}
