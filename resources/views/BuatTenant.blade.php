                        ...
                        <div class="container mx-auto">
                            <div class="flex flex-wrap -m-4">
                                ...
                                <label for="card1" class="w-1/3 p-4 cursor-pointer group">
                                    <input type="checkbox" id="card1" name="custom_tables[]" value="addDataDiri"
                                        class="hidden peer">

                                    <div
                                        class="border border-gray-200 rounded-lg p-6 peer-checked:border-indigo-500 peer-checked:bg-indigo-100">
                                        <div
                                            class="w-10 h-10 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 peer-checked:bg-indigo-500 peer-checked:text-white mb-4">
                                        ...
                                        <h2 class="text-lg font-medium text-gray-900 peer-checked:text-indigo-600">Data
                                            Diri</h2>
                                        <p class="text-base peer-checked:text-indigo-600">A brief description of the
                                            card.</p>
                                    </div>
                                </label>
                                {{-- BIAYA FASILITAS --}}
                                <label for="card3" class="w-1/3 p-4 cursor-pointer group">
                                    <input type="checkbox" id="card3" name="custom_tables[]" value="addBiaya"
                                        class="hidden peer">
                                    ...
                                    <div
                                        ...
                                        <h2 class="text-lg font-medium text-gray-900 peer-checked:text-indigo-600">
                                            Biaya</h2>
                                        <p class="text-base peer-checked:text-indigo-600">A brief description of the
                                            card.</p>
                                    </div>
                                ...
                                <label for="card2" class="w-1/3 p-4 cursor-pointer group">
                                    <input type="checkbox" id="card2" name="custom_tables[]"
                                        value="addLayananTambahan" class="hidden peer">
                                ...
                                <label for="card4" class="w-1/3 p-4 cursor-pointer group">
                                    <input type="checkbox" id="card4" name="custom_tables[]"
                                        value="addPemeliharaan" class="hidden peer">
                                ...
                                <label for="card5" class="w-1/3 p-4 cursor-pointer group">
                                    <input type="checkbox" id="card5" name="custom_tables[]" value="addKaryawan"
                                        class="hidden peer">
                                ...
                                <label for="card6" class="w-1/3 p-4 cursor-pointer group">
                                    <input type="checkbox" id="card6" name="custom_tables[]" value="addDenda"
                                        class="hidden peer">
