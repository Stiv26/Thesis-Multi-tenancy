            ...
            <div class="flex items-center justify-between px-3 py-3 rounded-lg">
                <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                    ...
                    <a href="#pembayaran" id="btnPembayaran" onclick="switchPage('pembayaran')" 
                        class="relative hidden items-center px-4 py-2 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 md:inline-flex">Riwayat Pembayaran</a>
                </nav>
            </div>    
        </section>
                    ...
                    <div class="bg-white rounded-lg shadow-md overflow-hidden">
                        <table class="min-w-full table-auto">
                            ...
                            <tbody class="text-sm text-gray-800">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="py-3 px-4 text-center text-gray-500">Belum ada pembayaran yang sedang diverifikasi.</td>
                                    </tr>
                                @endforelse 
                            </tbody>
                        </table>
                                    ...
                                    <div class="modal-body p-6 space-y-2">
                                        ...
                                        <div class="flex items-center space-x-4">
                                            <label for="nama" class="w-32 text-md font-medium text-gray-700">
                                                Nama Penyewa:</label>
                                            <input id="modal-verifikasi-nama" type="text" value="" name="nama"
                                                class="flex-1 px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-0"
                                                readonly>
                                        </div>
                                        ...
                                        <div class="flex items-center space-x-4">
                                            <label for="harga" class="w-32 text-md font-medium text-gray-700">
                                                Harga:</label>
                                            <input id="modal-verifikasi-harga" type="text" value="" name="harga"
                                                class="flex-1 px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-0"
                                                readonly>
                                        </div>
                                        ...
                                        <div class="flex items-center space-x-4" id="deposit-verifikasi-kontrak">
                                            <label for="deposit" class="w-32 text-md font-medium text-gray-700">
                                                Deposit:</label>
                                            <input id="modal-verifikasi-deposit" type="text" value="" name="deposit"
                                                class="flex-1 px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-0"
                                                readonly>
                                        </div>
                                        ...
                                        <div class="flex items-center space-x-4" id="denda-verifikasi-kontrak">
                                            <label for="denda" class="w-32 text-md font-medium text-gray-700">
                                                Denda:</label>
                                            <input id="modal-verifikasi-denda" type="text" value="" name="denda"
                                                class="flex-1 px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-0"
                                                readonly>
                                        </div>
                                        ...
                                        <div class="flex items-center space-x-4">
                                            <label for="total" class="w-32 text-md font-medium text-gray-700">
                                                Total Bayar:</label>
                                            <input id="modal-verifikasi-total" type="text" value="" name="total"
                                                class="flex-1 px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-0"
                                                readonly>
                                        </div>
                                ...
                                <div class="modal-body p-6 space-y-2">
                                    ...
                                    <div class="flex items-center space-x-4">
                                        <label for="bukti" class="w-32 text-md font-medium text-gray-700">
                                            Bukti:</label>
                                        <input required id="modal-buat-bukti" type="file" value="" name="bukti"
            ...
            <div x-data="{ showModal: false }" class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div class="modal fade p-4" id="ModalRiwayat" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog max-w-4xl mx-auto mt-24">
                        <div class="modal-content rounded-lg shadow-lg bg-white">
                            <div class="modal-header border-b border-gray-200 py-4 px-6">
                                <h3 class="text-2xl font-semibold text-gray-800" id="myModalLabel">Detail Riwayat Tagihan
                                </h3>
                                <button type="button" class="text-gray-400 hover:text-gray-600" data-dismiss="modal"
                                    aria-hidden="true">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
...
<script>
    function switchPage(page) {
        ...
        if (page === 'list') {
            ...
            btnPembayaran.classList.remove('text-gray-900', 'ring-1', 'ring-inset', 'ring-gray-300', 'hover:bg-gray-50');
        }
