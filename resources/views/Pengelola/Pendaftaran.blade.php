                ...
                <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                    <form action="{{ route('pendaftaran.store') }}" method="POST" class="mt-8">
                        ...
                        <div class="space-y-12">
                            ...
                            <div class="border-b border-gray-900/10 pb-12">
                                ...
                                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    ...
                                    <div class="sm:col-span-1 sm:col-start-1">
                                        ...
                                        <div class="mt-2">
                                            <input id="deposit" name="deposit" type="number" value="{{ $default->nominal_deposit }}" disabled
                                                class="text-center block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        </div>
                                    </div>
                            ...
                            <input type="hidden" name="deposit" value="{{ $default->nominal_deposit }}">
                            <input type="hidden" name="pertanggal_tagihan" value="{{ $default->pertanggal_tagihan_bulan }}">
                            <input type="hidden" name="pertanggal_denda" value="{{ $default->pertanggal_denda_bulan }}">
